...
namespace HelperService
{
    public class ConvertHelper
    {
        ...
        /// add by xjyong
        /// </summary>
        /// <param name="argImageFilePath">图片路径</param>
        /// <returns></returns>
        public static string ConvertImageToBase64String(string argImageFilePath)
        {
            try
            {
                //传入图片路径
                using (Bitmap bmp = new Bitmap(argImageFilePath))
                {
